...
class RegisterFromProvider extends ChangeNotifier {
  ...
  void validarErrores(List<Errore> errores) {
    for (var element in errores) {
      ...
      } else if (element.param == "contrasena" &&
          element.msg != "Las contraseñas no coinciden") {
        passwordError = element.msg;
      } else if (element.param == "nombre") {
        nameError = element.msg;
      } else if (element.param == "contrasena" &&
          element.msg == "Las contraseñas no coinciden") {
        confirmPasswordError = element.msg;
      }
    }
  }
}
